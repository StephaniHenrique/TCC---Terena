...
<html lang="pt">
    <head>
        ...
        <link rel="stylesheet" href="./css/interno/adotados.css">
    </head>
    <body>
        <header>
            <div class="toogle">
        ...
        <main>
            <div class="topo">
                ...
                <p class="subtitle">
                    encontre aqui os perfis de quem você se comprometeu em ajudar, visite esses perfis e veja se precisam da sua ajuda 
                </p>
            </div>
            <div class="container">
                <div class="perfil">
                    <img src="./img/fotoGrande.png" alt="">
                    <p>Maria Julia Agostin</p>
                </div>
                <div class="perfil">
                    <img src="./img/fotoGrande.png" alt="">
                    <p>Maria Julia Agostin</p>
