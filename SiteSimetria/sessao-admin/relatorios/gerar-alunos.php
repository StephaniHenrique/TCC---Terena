...
$html .= '<th>Cidade</th>';
$html .= '<th>Estado</th>';
$html .= '<th>Código da Instituição</th>';
$html .= '<th>Código da Escolaridade</th>';
$html .= '</tr>';
$html .= '</thead>';
$html .= '<tbody>';
...
$data  = date("d-m-Y | h:i:s"); 
	...
	$result_estudantes = "SELECT * FROM tbusers WHERE codNivel LIKE 1";
    ...
    while ($row_estudantes = mysqli_fetch_assoc($resultado_estudantes)){
        ...
        $html .= '<td>'.$row_estudantes['nascUsers'] . "</td>";
        $html .= '<td>'.$row_estudantes['cidadeUsers'] . "</td>";
        $html .= '<td>'.$row_estudantes['ufUsers'] . "</td>";
        $html .= '<td>'.$row_estudantes['codInstituicao'] . "</td>";
        $html .= '<td>'.$row_estudantes['codEscolaridade'] . "</td></tr>";
    ...
    <h2 style="text-align: center; color:#58565c;">Registros de Estudantes</h2>
